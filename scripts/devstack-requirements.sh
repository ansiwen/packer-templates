...
dnf -y install rsyslog yum-utils net-tools nfs-utils mlocate telnet sudo curl \
  wget dnf-yum git dnf dnf-plugins-core python-pip libvirt-devel sqlite-devel \
